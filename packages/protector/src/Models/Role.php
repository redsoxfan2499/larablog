...
namespace HyperdriveDesigns\Protector\Models;
...
class Role extends Model
{
    ...
    {
        return $this->belongsToMany('\HyperdriveDesigns\Protector\Models\Permission');
    }
    ...
    public function getPermissions()
    {
        ...
        $cacheKey   = 'hyperdrivedesigns.protector.permissions.'.$primaryKey;
